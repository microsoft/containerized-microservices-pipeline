...
AZURE_TRAFFIC_MANAGER_PROFILE_NAME=$PROJECT_NAME-$RESOURCE_NAME_STRING_AZURE_TRAFFIC_MANAGER
...
K8_DEPLOYMENT_KEYVAULT_NAME=$PROJECT_NAME-$RESOURCE_NAME_STRING_AZURE_KEY_VAULT_DEPLOY
