...
8. Visual Studio
	- Needed to do web and load testing. Web and load tests examples found [here](https://github.com/Microsoft/containerized-microservices-pipeline/tree/master/WebAndLoadTests).
