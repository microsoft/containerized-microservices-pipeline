...
8. Visual Studio
	- Will be use for web and load testing. Web and load tests examples found [here](https://github.com/Microsoft/containerized-microservices-pipeline/tree/master/WebAndLoadTests).
